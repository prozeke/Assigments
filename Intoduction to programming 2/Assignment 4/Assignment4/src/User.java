...
public class User {
	 ...
	 *            users school
	 */
	public User(String name, String userName, String password, Date dateOfBirth, String school, String relationship) {
		this.numberOfUser++;
		this.name = name;
	...
	public void setRelationship(String relaitonship) {
		this.relationship = relaitonship;
	}
	 ...
	 */
	public void update(String name, String date, String school, String relationship) {
		this.setName(name);
	...
	public static User sUserNametoUser(String userName) {
	...
	public void postText(String text, String slongitude, String slatitude, ArrayList<User> tags) {
		...
		this.posts.add(post);
		UserCollection.allPosts.add(post);
	}
